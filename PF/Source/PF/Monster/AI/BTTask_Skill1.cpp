...
EBTNodeResult::Type UBTTask_Skill1::AbortTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UBTTask_Skill1::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
	...
	if (Monster->GetMonsterPhase() != EMonsterPhase::Skill1)
	{
		FinishLatentTask(OwnerComp, EBTNodeResult::Failed);
		return;
	}
...
void UBTTask_Skill1::OnTaskFinished(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, EBTNodeResult::Type TaskResult)
{
